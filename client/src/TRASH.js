...
//             </th>
//             <td>
//                 <label className="display-6 form-label">{user.city}</label>
...
//             </th>
//             <td>
//                 <label className="display-6 form-label">{user.street}</label>
...
//             </th>
//             <td>
//                 <label className="display-6 form-label">{user.house}</label>
...
//             </th>
//             <td>
//                 <label className="display-6 form-label">{user.flat}</label>
